...
##### parameters #####
list_json="/private/yhhe/mini_trident/ebrains_wsi_list.json" # path to the JSON list of slides
job_dir="/private/yhhe/mini_trident/mini_trident_datasets/ebrains" # directory to store outputs
...
encoders=(conch_v1 conch_v1_5 ctranspath gpfm h_optimus_0 h0_mini keep lunit_p16 mstar pathorchestra plip prov_gigapath) # musk
# encoders=(uni_v1 uni_v2 virchow_1 virchow_2)
