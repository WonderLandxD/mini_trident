...
model weights: https://huggingface.co/JWonderLand/StainNet
"""

class StainNet_Small(nn.Module):
    def __init__(self):
        super().__init__()

        import timm
        import torchvision.transforms as transforms
        self.backbone = timm.create_model('hf_hub:JWonderLand/StainNet', pretrained=True)
