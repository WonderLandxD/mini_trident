...
encoders=(uni_v1 uni_v2 virchow_1 virchow_2) # patch encoder names, loop over each in one tmux # conch_v1 conch_v1_5 ctranspath gpfm h_optimus_0 h0_mini keep lunit_p16 pathorchestra plip prov_gigapath 
